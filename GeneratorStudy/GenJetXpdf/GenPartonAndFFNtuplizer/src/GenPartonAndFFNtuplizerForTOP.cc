...
class GenPartonAndFFNtuplizerForTOP : public edm::EDAnalyzer {
   public:
      explicit GenPartonAndFFNtuplizerForTOP(const edm::ParameterSet&);
      ~GenPartonAndFFNtuplizerForTOP();
...
//
GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP(const edm::ParameterSet& iConfig)
...
/*
   std::cerr<<"[GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP] genParticles: " << gsrc_ << std::endl;
   std::cerr<<"[GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP] genJets     : " << gjsrc_ << std::endl;
   std::cerr<<"[GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP] pthatCut    : " << pthatCut_ << std::endl;
   std::cerr<<"[GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP] crossX      : " << crossX_ << std::endl;
   std::cerr<<"[GenPartonAndFFNtuplizerForTOP::GenPartonAndFFNtuplizerForTOP] numEvt      : " << numEvt_ << std::endl;
*/
}


GenPartonAndFFNtuplizerForTOP::~GenPartonAndFFNtuplizerForTOP()
{
...
void
GenPartonAndFFNtuplizerForTOP::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
GenPartonAndFFNtuplizerForTOP::beginJob()
{
...
void 
GenPartonAndFFNtuplizerForTOP::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
GenPartonAndFFNtuplizerForTOP::beginRun(edm::Run const&, edm::EventSetup const&)
{
...
void 
GenPartonAndFFNtuplizerForTOP::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
GenPartonAndFFNtuplizerForTOP::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
GenPartonAndFFNtuplizerForTOP::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
GenPartonAndFFNtuplizerForTOP::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(GenPartonAndFFNtuplizerForTOP);
