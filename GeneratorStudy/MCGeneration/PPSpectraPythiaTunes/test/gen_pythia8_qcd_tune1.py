...
# ============= Pythia 8 setting  ================================
#from Configuration.Generator.MinBias_7TeV_pythia8_cff import *

# to skip unknown pdg id
...
updatePy8ProcParameters(process.generator,options.processType,options.sqrtS)
...
process = enablePythia8Mode(process) # Pythia8 mode
