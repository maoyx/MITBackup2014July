...
/*    TH2F * genjetpt[nbin];
    ...
    //  TH2F * dphiJS[nbin]; //phi diviration from jet phi 
    //   TH2F * detaJS[nbin] ; //eta diviration from jet eta 
    TH2F * gensubDiffJS[nbin][nrbin]; //differential sub-jet shapes (pho(r)) hist.
    TH2F * gensubIntJS[nbin][nrbin]; //Integrated sub-jet shapes (psi(r)) hist.
    ...
    TH2F * genbkgsubDiffJS[nbin][nrbin]; //differential sub-jet shapes (pho(r)) hist.
    TH2F * genbkgsubIntJS[nbin][nrbin]; //Integrated sub-jet shapes (psi(r)) hist. 
  */  
    //   }
};
...
hist_class::hist_class(TString the_desc)
{
  ...
  /*      if(IsMC){
            genjetpt[ibin] = new TH2F(Form("genjetpt_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("genjetpt_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 500, 0.5, 500.5);
            genjetpt[ibin]->GetXaxis()->SetTitle("p_{T}^{rec} (GeV/c)");
            genjetpt[ibin]->GetYaxis()->SetTitle("p_{T}^{gen} (GeV/c)");   
            gensubjetpt[ibin] = new TH2F(Form("gensubjetpt_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("gensubjetpt_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5,500, 0.5, 500.5);
            gensubjetpt[ibin]->GetXaxis()->SetTitle("p_{T}^{rec} (GeV/c)");
            gensubjetpt[ibin]->GetYaxis()->SetTitle("p_{T}^{gen} (GeV/c)");            
            gendphi[ibin] = new TH2F(Form("gendphi_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("gendphi_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5,120, -4.05, 8.05);
            gendphi[ibin]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
            gendphi[ibin]->GetYaxis()->SetTitle("#Delta#phi");            
            genptRatio[ibin] = new TH2F(Form("genptRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("genptRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 50., 0.05,5.05);
            genptRatio[ibin]->GetXaxis()->SetTitle("p_{T}^{gen} (GeV/c)");
            genptRatio[ibin]->GetYaxis()->SetTitle("p_{T}^{rec}/p_{T}^{gen}");   
            genphiRatio[ibin] = new TH2F(Form("genphiRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("genphiRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5,100, -5.05, 5.05);
            genphiRatio[ibin]->GetXaxis()->SetTitle("p_{T}^{rec} (GeV/c)");
            genphiRatio[ibin]->GetYaxis()->SetTitle("#phi_{gen}-#phi_{rec}");            
            genetaRatio[ibin] = new TH2F(Form("genetaRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), Form("genetaRatio_%.f-%.f%%",centr[ibin],centr[ibin+1]), 500, 0.5, 500.5,100, -5.05,5.05);
   ...
   /*         if(IsMC){
                genDiffJS[ibin][ir] = new TH2F(Form("gendifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("gendifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genDiffJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genDiffJS[ibin][ir]->GetYaxis()->SetTitle("#rho (r)");
                genIntJS[ibin][ir] = new TH2F(Form("genIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("genIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genIntJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genIntJS[ibin][ir]->GetYaxis()->SetTitle(Form("#psi(r=%1.2f)",deltacone*(ir+1)));
                
                gensubDiffJS[ibin][ir] = new TH2F(Form("gensubjetdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("gensubjetdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                gensubDiffJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                gensubDiffJS[ibin][ir]->GetYaxis()->SetTitle("#rho (r)");
                gensubIntJS[ibin][ir] = new TH2F(Form("gensubjetIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("gensubjetIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                gensubIntJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                gensubIntJS[ibin][ir]->GetYaxis()->SetTitle(Form("#psi(r=%1.2f)",deltacone*(ir+1)));
                
                genbkgDiffJS[ibin][ir] = new TH2F(Form("genbkgdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("genbkgdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genbkgDiffJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genbkgDiffJS[ibin][ir]->GetYaxis()->SetTitle("#rho (r)");
                genbkgIntJS[ibin][ir] = new TH2F(Form("genbkgIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("genbkgIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genbkgIntJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genbkgIntJS[ibin][ir]->GetYaxis()->SetTitle(Form("#psi(r=%1.2f)",deltacone*(ir+1)));
                genbkgsubDiffJS[ibin][ir] = new TH2F(Form("genbkgsubjetdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("genbkgsubjetdifferentialJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genbkgsubDiffJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genbkgsubDiffJS[ibin][ir]->GetYaxis()->SetTitle("#rho (r)");
                genbkgsubIntJS[ibin][ir] = new TH2F(Form("genbkgsubjetIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), Form("genbkgsubjetIntegratedJSdR%.f_%.f_Cen%.f-%.f%%",rbin[ir]*100,rbin[ir+1]*100,centr[ibin],centr[ibin+1]), 500, 0.5, 500.5, 150, 0.005, 1.505);
                genbkgsubIntJS[ibin][ir]->GetXaxis()->SetTitle("p_{T}^{jet} (GeV/c)");
                genbkgsubIntJS[ibin][ir]->GetYaxis()->SetTitle(Form("#psi(r=%1.2f)",deltacone*(ir+1)));    
  ...
  /*      if(IsMC){
    ...
    */    
      ...
      /*      if(IsMC){
                ...
                delete gensubDiffJS[ibin][ir];
                delete gensubIntJS[ibin][ir];
                delete genbkgDiffJS[ibin][ir];
                delete genbkgIntJS[ibin][ir];
                delete genbkgsubDiffJS[ibin][ir];
                delete genbkgsubIntJS[ibin][ir];
            }
      */  }
    }
...
void hist_class::Write()
{
    ...
    if(IsMC)
        out_name=Form("%s%s_ChargedJetPt%.f_%.fTrk%.fEta%.f_BkgEtaBound%.f_CenBin%d_Nrbin%d_Pthat%d%s",dataType.Data(),coll.Data(),leadingjetcut,subleadjetcut,trackcut, etacut,etalimit*10, nbin,nrbin,pthat, intputFile.Data());
    else
        out_name=Form("%s%s_ChargedJetPt%.f_%.fTrk%.fEta%.f_BkgEtaBound%.f_CenBin%d_Nrbin%d_%s",dataType.Data(),coll.Data(),leadingjetcut,subleadjetcut,trackcut, etacut,etalimit*10, nbin,nrbin, intputFile.Data());
   ...
   // TFile *out_file = new TFile(Form("/Users/ymao/group/CMS/anaOutputs/%s",out_name.Data()), "RECREATE");
     ...
     */
       ...
       /*     if(IsMC){
                ...
                gensubDiffJS[ibin][ir]->Write();
                gensubIntJS[ibin][ir]->Write();
                genbkgDiffJS[ibin][ir]->Write();
                genbkgIntJS[ibin][ir]->Write();
                genbkgsubDiffJS[ibin][ir]->Write();
                genbkgsubIntJS[ibin][ir]->Write();
...
int main()
{
    ...
    //    dataPath= "/Users/ymao/group/CMS/hiForest"; //local analysis
          ...
          //         dataPath= Form("/net/hisrv0001/home/icali/hadoop/Hydjet1.8/Z2/Dijet_merged",pthat); //mit path for HI
                else    
    ...
    if(my_hists->IsMC!=kTRUE){  //real data analysis
        ...
        //    intputFile=Form("mit_pawan_PbPb2760_Dijet_Hydrum_dijet%d.root", pthat);
         ...
         // intputFile=Form("Dijet%d_merged.root",pthat);
        else 
 ...
 //   GenParticle * my_GenPart = new GenParticle(GenPart_tree);      
   ...
   //     if(my_hists->IsMC==kTRUE)my_GenPart->fChain->GetEntry(evi);
        ...
        for(int ijet = 0 ; ijet <my_ct->nref; ijet++){
            ...
            //remove flucluation with too large pt from small MC pthat sample
            if(my_hists->IsMC==kTRUE && my_ct->jtpt[ijet]>3*pthat) continue ;
        ...
        for(int itr = 0 ; itr < my_tr->nTrk ; itr++){
            ...
            if(dr<conesize && dr2<conesize) {
                ...
                my_hists->trackpt[curr_bin]->Fill(tr_pt, weight);
            ...
            else { //PF outside both jet
                //  else if(dr2>1.&&dr>1.){ //PF outside both jet
                double bkgsub_dr = TMath::Sqrt((tr_phi-bkg_subphi)*(tr_phi-bkg_subphi)+(tr_eta-bkg_subeta)*(tr_eta-bkg_subeta));
                double bkg_dr = TMath::Sqrt((tr_phi-bkg_phi)*(tr_phi-bkg_phi)+(tr_eta-bkg_eta)*(tr_eta-bkg_eta));   
                //                if(bkg_dr<conesize && bkgsub_dr<conesize) {
                //                    cout <<"!!!! two bkg cones are overlap with track: "<<itr <<"eta: " <<tr_eta <<" phi:" <<tr_phi << endl;
                //                    continue ;
                //                }       
                if(bkg_dr<=conesize){
                    bkgsumpt+=tr_pt ;
        ...
        //    if(rho[ir]==sumpt) cout<<"evt ="<<evi<<" ir="<<ir<<"sum ="<<sumpt<<"psi ="<<psi[ir] <<" rho ="<<rho[ir]<<endl;
            psi[ir]/=sumpt;
            rho[ir]/=sumpt;
            subpsi[ir]/=sumsubpt;
            subrho[ir]/=sumsubpt;
        ...
        if(my_hists->IsMC==kTRUE){
            ...
            my_hists->genjetpt[curr_bin]->Fill(lead_pt,genjet_pt);
            my_hists->gensubjetpt[curr_bin]->Fill(sublead_pt,gensubjet_pt);
            my_hists->gendphi[curr_bin]->Fill(lead_pt,TMath::Abs(genjet_phi-gensubjet_phi));
            my_hists->genptRatio[curr_bin]->Fill(genjet_pt,lead_pt/genjet_pt);
            my_hists->genphiRatio[curr_bin]->Fill(genjet_pt,genjet_phi-jet_phi);
            my_hists->genetaRatio[curr_bin]->Fill(genjet_pt,genjet_eta-jet_eta);
            
            if(genjet_eta<=etalimit) {
                if(genbkgetacut<=(etacut-etalimit)||genjet_eta<0.)
                    genbkg_eta = genjet_eta+genbkgetacut;
                else 
                    genbkg_eta = genjet_eta-genbkgetacut;
                if(genjet_phi<0.)
                    genbkg_phi = genjet_phi+genbkgphicut;
                else 
                    genbkg_phi = genjet_phi-genbkgphicut;
            }
            else {
            ...
            if(gensubjet_eta<=etalimit) {
                if(genbkgetacut<=(etacut-etalimit)||gensubjet_eta<0.)                    genbkg_subeta = gensubjet_eta+genbkgetacut;
                else
                    genbkg_subeta = gensubjet_eta-genbkgetacut;
                if(gensubjet_phi<0.)
                    genbkg_subphi = gensubjet_phi+genbkgphicut;
                else 
                    genbkg_subphi = gensubjet_phi-genbkgphicut;
            }
            else {
            ...
            for(int ipart = 0 ; ipart < my_GenPart->mult ; ipart++){
                ...
                double dr =TMath::Sqrt((gen_phi-genjet_phi)*(gen_phi-genjet_phi)+(gen_eta-genjet_eta)*(gen_eta-genjet_eta));
                double dr2 =TMath::Sqrt((gen_phi-gensubjet_phi)*(gen_phi-gensubjet_phi)+(gen_eta-gensubjet_eta)*(gen_eta-gensubjet_eta));
                if(dr<conesize && dr2<conesize) {
                    ...
                    gensumsubpt+=gen_pt;
                    for(int ir = 0 ; ir <nrbin; ir++){
                        if(dr2<=rbin[ir+1]) gensubpsi[ir]+=gen_pt ;
                        if(dr2>rbin[ir]&&dr2<=rbin[ir+1]){
                            gensubrho[ir]+=gen_pt ;
                        }
                    ...
                    //                if(genbkg_dr<=conesize && genbkgsub_dr<conesize) {
            ...
            for(int ir = 0 ; ir <nrbin; ir++){            
                ...
                my_hists->gensubDiffJS[curr_bin][ir]->Fill(gensubjet_pt, gensubrho[ir],weight);
                my_hists->gensubIntJS[curr_bin][ir]->Fill(gensubjet_pt, gensubpsi[ir],weight);
                // rho/=deltacone ;
                ...
                my_hists->genbkgsubDiffJS[curr_bin][ir]->Fill(gensubjet_pt, genbkgsubrho[ir],weight);
                my_hists->genbkgsubIntJS[curr_bin][ir]->Fill(gensubjet_pt, genbkgsubpsi[ir],weight);                   
            }
