...
// Wed May  2 10:13:15 2012 by ROOT version 5.27/06b
// from TTree HltTree/
...
Int_t HIHLT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HIHLT::LoadTree(Long64_t entry)
{
...
void HIHLT::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("reconstruction_step", &reconstruction_step, &b_reconstruction_step);
   fChain->SetBranchAddress("reconstruction_step_Prescl", &reconstruction_step_Prescl, &b_reconstruction_step_Prescl);
...
void HIHLT::Show(Long64_t entry)
{
...
Int_t HIHLT::Cut(Long64_t entry)
{
