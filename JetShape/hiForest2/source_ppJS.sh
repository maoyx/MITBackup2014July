...
g++ -Wall -I$ROOTSYS/include -L$ROOTSYS/lib `root-config --libs --glibs` class_def/skim.C class_def/Evt.C class_def/HLT.C class_def/track.C class_def/akPu3PFJet.C class_def/pfTree.C class_def/GenParticle.C ppChargeJS.C -o ppJS.out
#g++ -Wall -I$ROOTSYS/include -L$ROOTSYS/lib `root-config --libs --glibs` class_def/skim.C class_def/Evt.C class_def/HLT.C class_def/MergedTrack.C class_def/akPu3PFJet.C class_def/pfTree.C class_def/GenParticle.C ppChargeJS.C -o ppJS.out
