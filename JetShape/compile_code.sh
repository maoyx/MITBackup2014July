...
#g++ -Wall -I$ROOTSYS/include -L$ROOTSYS/lib `root-config --libs --glibs` class_def/skim.C class_def/Evt.C class_def/HLT.C class_def/track.C class_def/akPu3PFJet.C class_def/pfTree.C ChargeJetShape.C -o chargejet.out
g++ -Wall -I$ROOTSYS/include -L$ROOTSYS/lib `root-config --libs --glibs` class_def/skim.C class_def/Evt.C class_def/HIHLT.C class_def/track.C class_def/akPu3PFJet.C class_def/pfTree.C ChargeJetShape.C -o chargejet.out
