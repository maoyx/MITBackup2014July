...
boost_header_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/boost/1.44.0-cms3/include
...
cascade             := cascade
ALL_TOOLS      += cascade
cascade_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/cascade/2.2.0-cms6/include
...
castor_header_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/castor/2.1.9.8-cms2/include /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/castor/2.1.9.8-cms2/include/shift
...
ccompiler_LOC_FLAGS_SCRAM_COMPILER_NAME  := gcc434
...
charybdis             := charybdis
ALL_TOOLS      += charybdis
charybdis_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/charybdis/1.003-cms6/include
...
classlib             := classlib
ALL_TOOLS      += classlib
classlib_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/classlib/3.1.2-cms2/include
...
clhepheader_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/clhep/2.0.4.6-cms/include
...
cmsswdata             := cmsswdata
ALL_TOOLS      += cmsswdata
cmsswdata_LOC_FLAGS_CMSSW_DATA_PACKAGE  := FastSimulation/MaterialEffects=20 FastSimulation/PileUpProducer=V04-04-26-00 Fireworks/Geometry=V06-13-04 Geometry/CMSCommonData=V01-07-08 Geometry/CSCGeometryBuilder=V01-07-09 Geometry/CaloEventSetup=V03-11-02 Geometry/DTGeometryBuilder=V00-04-13 Geometry/EcalCommonData=V05-03-11 Geometry/EcalSimData=V01-01-04 Geometry/EcalTestBeam=V00-08-21 Geometry/FP420CommonData=V00-05-00-01 Geometry/FP420SimData=V00-05-01 Geometry/ForwardCommonData=V01-04-05 Geometry/ForwardSimData=V02-01-04 Geometry/HcalCommonData=V01-04-10 Geometry/HcalSimData=V01-02-02 Geometry/HcalTestBeamData=V01-07-02 Geometry/MTCCTrackerCommonData=V01-00-10 Geometry/MuonCommonData=V01-05-01 Geometry/MuonSimData=V01-02-04 Geometry/RPCGeometryBuilder=V01-03-09 Geometry/TrackerCommonData=V01-07-08 Geometry/TrackerRecoData=V01-04-03 Geometry/TrackerSimData=V01-02-03 Geometry/TwentyFivePercentTrackerCommonData=V00-00-03 L1Trigger/RPCTrigger=2 MagneticField/Interpolation=26 RecoMuon/MuonIdentification=20 RecoParticleFlow/PFBlockProducer=19 RecoParticleFlow/PFProducer=2 RecoParticleFlow/PFTracking=24 RecoTracker/RingESSource=V00-01-14 RecoTracker/RoadMapESSource=V01-01-11 SimG4CMS/Calo=20 SimG4CMS/Forward=1 Validation/Geometry=19
...
cppunit             := cppunit
ALL_TOOLS      += cppunit
cppunit_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/cppunit/1.12.1-cms2/include
...
curl             := curl
ALL_TOOLS      += curl
curl_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/curl/7.20.0-cms2/include
...
cxxcompiler_LOC_FLAGS_CXXFLAGS  := -O2 -pedantic -ansi -pthread -pipe -Werror=overflow -Wimplicit -Werror=strict-overflow -Werror=array-bounds -Werror=format-contains-nul -Werror=type-limits -felide-constructors -fmessage-length=0 -ftemplate-depth-300 -Wall -Wno-non-template-friend -Wno-long-long -Wreturn-type -Wunused -Wparentheses -Wno-deprecated -Werror=return-type -Werror=missing-braces -Werror=unused-value -Werror=address -Werror=format -Werror=sign-compare -Werror=write-strings -fdiagnostics-show-option
...
cxxcompiler_LOC_FLAGS_SCRAM_COMPILER_NAME  := gcc434
...
db4             := db4
ALL_TOOLS      += db4
db4_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/db4/4.4.20-cms/include
...
dcap             := dcap
ALL_TOOLS      += dcap
dcap_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/dcap/2.47.5.0-cms2/include
...
dpm             := dpm
ALL_TOOLS      += dpm
dpm_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/dpm/1.8.0.1-cms2/include
...
evtgenlhc             := evtgenlhc
ALL_TOOLS      += evtgenlhc
evtgenlhc_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/evtgenlhc/9.1-cms10
...
expat             := expat
ALL_TOOLS      += expat
expat_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/expat/2.0.0-cms3/include
...
f77compiler_LOC_FLAGS_FFLAGS  := -fno-second-underscore -Wunused -Wuninitialized -O2
...
f77compiler_LOC_FLAGS_SCRAM_COMPILER_NAME  := gcc434
...
fastjet             := fastjet
ALL_TOOLS      += fastjet
fastjet_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/fastjet/2.4.4-cms/include
...
frontier_client_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/frontier_client/2.8.4/include
...
geant4core_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/geant4/9.4-cms/include
...
hector             := hector
ALL_TOOLS      += hector
hector_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/hector/1_3_4-cms73/include
...
heppdt             := heppdt
ALL_TOOLS      += heppdt
heppdt_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/heppdt/3.03.00-cms/include
...
herwig             := herwig
ALL_TOOLS      += herwig
herwig_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/herwig/6.520-cms9/include
...
ktjet             := ktjet
ALL_TOOLS      += ktjet
ktjet_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/ktjet/1.06-cms3/include
...
lhapdf             := lhapdf
ALL_TOOLS      += lhapdf
lhapdf_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/lhapdf/5.8.5-cms2/include
...
libhepml             := libhepml
ALL_TOOLS      += libhepml
libhepml_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/libhepml/0.2.1-cms/interface
...
libjpg             := libjpg
ALL_TOOLS      += libjpg
libjpg_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/libjpg/8b/include
...
mcdb             := mcdb
ALL_TOOLS      += mcdb
mcdb_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/mcdb/1.0.2-cms4/interface
...
meschach             := meschach
ALL_TOOLS      += meschach
meschach_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/meschach/1.2.pCMS1-cms/include
...
mimetic             := mimetic
ALL_TOOLS      += mimetic
mimetic_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/mimetic/0.9.6-cms3/include
...
oracle             := oracle
ALL_TOOLS      += oracle
oracle_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/oracle/100.0/include
...
pcre             := pcre
ALL_TOOLS      += pcre
pcre_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/pcre/4.4-cms/include
...
protobuf             := protobuf
ALL_TOOLS      += protobuf
protobuf_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/protobuf/2.4.1/include
...
pythia8             := pythia8
ALL_TOOLS      += pythia8
pythia8_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/pythia8/145-cms4/include
...
qt3support_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/Qt3Support
...
rivet             := rivet
ALL_TOOLS      += rivet
rivet_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/rivet/1.5.1-cms5/include
...
rootcint             := rootcint
ALL_TOOLS      += rootcint
rootcint_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms25/cint
...
sherpa             := sherpa
ALL_TOOLS      += sherpa
sherpa_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/sherpa/1.3.0-cms3/include/SHERPA-MC
...
sigcpp             := sigcpp
ALL_TOOLS      += sigcpp
sigcpp_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/sigcpp/2.2.3-cms3/include/sigc++-2.0
...
tauola_LOC_USE := pythia6 f77compiler tauola_headers
...
tauolapp             := tauolapp
ALL_TOOLS      += tauolapp
tauolapp_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/tauolapp/1.0.2a-cms2/include
...
thepeg             := thepeg
ALL_TOOLS      += thepeg
thepeg_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/thepeg/1.7.0-cms4/include
...
tkonlinesw_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/tkonlinesw/2.7.0-cms11/include
...
uuid             := uuid
ALL_TOOLS      += uuid
uuid_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/uuid/1.38-cms2/include
...
xdaq             := xdaq
ALL_TOOLS      += xdaq
xdaq_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/xdaq/VR17173-cms/include /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/xdaq/VR17173-cms/include/linux
...
xrootd             := xrootd
ALL_TOOLS      += xrootd
xrootd_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/xrootd/5.28.00d/src
...
xz             := xz
ALL_TOOLS      += xz
xz_LOC_INCLUDE := /osg/app/cmssoft/cms/slc5_amd64_gcc434/external/xz/5.0.3/include
