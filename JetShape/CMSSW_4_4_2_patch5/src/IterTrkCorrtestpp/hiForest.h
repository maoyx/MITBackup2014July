...
//       trackCorrections.push_back(new TrackingCorrections("Forest2STAv12","Forest2_MergedGeneral_j2"));
      ...
      for(int i = 0; i < trackCorrections.size(); ++i){
          if (!pp) {
/*            //! efficiency calculated in 4 centrality bins
...
*/                       //! efficiency calculated in 5 centrality bins
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj50_akPu3PF_100_-1_-1000_genJetMode0.root",50);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj80_akPu3PF_100_-1_-1000_genJetMode0.root",80);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj100_akPu3PF_100_-1_-1000_genJetMode0.root",100);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj120_akPu3PF_100_-1_-1000_genJetMode0.root",120);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj170_akPu3PF_100_-1_-1000_genJetMode0.root",170);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj200_akPu3PF_100_-1_-1000_genJetMode0.root",200);
              trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj250_akPu3PF_100_-1_-1000_genJetMode0.root",250);
             trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec/TrkCorrtest_PbPb5Cent_HydjetSigdj300_akPu3PF_100_-1_-1000_genJetMode0.root",300);
