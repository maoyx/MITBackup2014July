...
// Track pT binning
const int nbins_trackPt=	     13;
Double_t boundaries_trackPt[nbins_trackPt+1] = {   0.5,0.6,0.7,0.8,0.9, 1.0, 2.0, 4.0, 8.0, 20.0, 30.0, 50.0, 100.0 , 200.0 };
...
class JetData
{
   ...
   JetData(TTree *t, bool setBranch=1) {
      ...
      t->Branch("leadingJetTrackMax",&leadingJetTrackMax,"leadingJetTrackMax/F");
      ...
      t->Branch("subleadingJetTrackMax",&subleadingJetTrackMax,"subleadingJetTrackMax/F");
