...
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MC.root -useweight true -algs ak2PFJetAnalyzer -drmax 0.2 -output jra_hiF_ak2PF_dijet.root
...
# draw figures with l2 correction 
...
# draw final corrections 
jet_draw_corrections_x -algs ak3pf -path "" -outputDir /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/testCorrections/ -era JEC_ak3PF_dijet -useL2Cor true -useL3Cor -true -outputFormat .pdf
jet_draw_corrections_x -algs ak3calo -path "" -outputDir /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/testCorrections/ -era JEC_ak3Calo_dijet -useL2Cor true -useL3Cor -true -outputFormat .pdf
