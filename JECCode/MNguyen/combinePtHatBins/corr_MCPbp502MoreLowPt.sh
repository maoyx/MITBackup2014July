...
.L loadfwlite.C
.x load_JEC.C 
.x weight_PtHatBins_JetsR3_5.C+("/mnt/hadoop/cms/store/user/kjung/Pbp_ForestProdApr14_v3_Merged/Pbp_ForestProdApr14_pthat15_v3output0.root","/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/CorrPbpJet15v2.root",30,5.335E-01,true)
.q
EOF
root -l -b <<EOF
.L loadfwlite.C
...
.L loadfwlite.C
.x load_JEC.C 
.x weight_PtHatBins_JetsR3_5.C+("/mnt/hadoop/cms/store/user/kjung/Pbp_ForestProdApr14_v3_Merged/Pbp_ForestProdApr14_pthat30_v3output0.root","/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/CorrPbpJet30v2.root",50,3.378E-02,true)
.q
EOF
root -l -b <<EOF
.L loadfwlite.C
...
rm -f /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen//combinePtHatBins/jet_CorrPbp502_Combined2013_2014MC.root
hadd /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen//combinePtHatBins/jet_CorrPbp502_Combined2013_2014MC.root /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/CorrPbpJet*.root
