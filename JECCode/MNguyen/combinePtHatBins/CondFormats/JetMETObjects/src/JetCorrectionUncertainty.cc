  ...
  for(unsigned i=0;i<fNames.size();i++)
    {
      if (fNames[i] == "JetEta")
        {
          //if (!mIsJetEtaset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet eta is not set";
	  if (!mIsJetEtaset)cout<<"JetCorrectionUncertainty::"<<" jet eta is not set"<<endl;
          else result.push_back(mJetEta);
        }
      else if (fNames[i] == "JetPt")
        {
          //if (!mIsJetPtset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet pt is not set";  
	  if (!mIsJetPtset)cout<<"JetCorrectionUncertainty::"<<" jet pt is not set"<<endl;  
          else result.push_back(mJetPt);
        }
      else if (fNames[i] == "JetPhi")
        {
          //if (!mIsJetPhiset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet phi is not set";  
          if (!mIsJetPhiset)cout<<"JetCorrectionUncertainty::"<<" jet phi is not set"<<endl;  
          else result.push_back(mJetPt);
        }
      else if (fNames[i] == "JetE")
        {
          //if (!mIsJetEset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet energy is not set";
          if (!mIsJetEset)cout<<"JetCorrectionUncertainty::"<<" jet energy is not set"<<endl;
          else result.push_back(mJetE);
        }
      else if (fNames[i] == "JetEMF")
        {
          //if (!mIsJetEMFset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet emf is not set";
          if (!mIsJetEMFset)cout<<"JetCorrectionUncertainty::"<<" jet emf is not set"<<endl;
          else result.push_back(mJetEMF);
        } 
      else if (fNames[i] == "LepPx")
        {
          //if (!mIsLepPxset)throw cms::Exception("JetCorrectionUncertainty::")<<" lepton px is not set";  
	  if (!mIsLepPxset)cout<<"JetCorrectionUncertainty::"<<" lepton px is not set"<<endl;  
          else result.push_back(mLepPx);
        }
      else if (fNames[i] == "LepPy")
        {
          //if (!mIsLepPyset)throw cms::Exception("JetCorrectionUncertainty::")<<" lepton py is not set";  
          if (!mIsLepPyset)cout<<"JetCorrectionUncertainty::"<<" lepton py is not set"<<endl;  
          else result.push_back(mLepPy);
        }
      else if (fNames[i] == "LepPz")
        {
          //if (!mIsLepPzset)throw cms::Exception("JetCorrectionUncertainty::")<<" lepton pz is not set";  
          if (!mIsLepPzset)cout<<"JetCorrectionUncertainty::"<<" lepton pz is not set"<<endl;  
          else result.push_back(mLepPz);
        }
      else
	{
...
float JetCorrectionUncertainty::getPtRel()
{
  ...
  //if (!(lj2 > 0))throw cms::Exception("JetCorrectionUncertainty")<<" not positive lepton-jet momentum: "<<lj2;
  if (!(lj2 > 0))cout<<"JetCorrectionUncertainty"<<" not positive lepton-jet momentum: "<<lj2<<endl;
