...
.L loadfwlite.C
.x load_JEC.C 
.x weight_PtHatBins_JetsR3_5.C+("/mnt/hadoop/cms/store/user/kjung/Pbp_ForestProdApr14_v3_Merged/Pbp_ForestProdApr14_pthat30_v3output0.root","/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/PbpJet30v2.root",50,3.378E-02,false)
.q
EOF
root -l -b <<EOF
.L loadfwlite.C
.x load_JEC.C 
.x weight_PtHatBins_JetsR3_5.C+("/mnt/hadoop/cms/store/user/dgulhan/HIJING_GEN-SIM_revrese_betap/Hijing_reverse_Dijet30_5p02TeV_FOREST_v1_merged2/pt30_HIJING_GEN-SIM_revrese_betap_merged_forest_0.root","/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/PbpJet30.root",50,3.378E-02,false)
.q
EOF
root -l -b <<EOF
.L loadfwlite.C
...
rm -f /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/jet_Pbp502_Combined2013_2014MC.root
hadd /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/jet_Pbp502_Combined2013_2014MC.root /net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/combinePtHatBins/PbpJet*.root
