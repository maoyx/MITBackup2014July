...
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak2PFJetAnalyzer -drmax 0.2 -output jra_hiF_ak2PF_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak3PFJetAnalyzer -drmax 0.3 -output jra_hiF_ak3PF_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak4PFJetAnalyzer -drmax 0.4 -output jra_hiF_ak4PF_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak5PFJetAnalyzer -drmax 0.5 -output jra_hiF_ak5PF_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak6PFJetAnalyzer -drmax 0.6 -output jra_hiF_ak6PF_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak1CaloJetAnalyzer -drmax 0.1 -output jra_hiF_ak1Calo_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak2CaloJetAnalyzer -drmax 0.2 -output jra_hiF_ak2Calo_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak3CaloJetAnalyzer -drmax 0.3 -output jra_hiF_ak3Calo_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak4CaloJetAnalyzer -drmax 0.4 -output jra_hiF_ak4Calo_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak5CaloJetAnalyzer -drmax 0.5 -output jra_hiF_ak5Calo_dijet.root
jet_response_analyzer_x  fine_binning_ptRebin_noHF_noLowPt.config -input dijet_pp_mergedpthatbins_2012MC.root -useweight true -algs ak6CaloJetAnalyzer -drmax 0.6 -output jra_hiF_ak6Calo_dijet.root
