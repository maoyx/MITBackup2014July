...
//  if (collisionMode == cPbPb || collisionMode == cPP) trackTree        = (TTree*) inf->Get("anaTrack/trackTree");
  if (collisionMode == cPbPb ) trackTree        = (TTree*) inf->Get("anaTrack/trackTree");
 // if (collisionMode == cPbPb ) trackTree        = (TTree*) inf->Get("ppTrack/trackTree");
  if (collisionMode == cPPb) trackTree        = (TTree*) inf->Get("ppTrack/trackTree");
  if (collisionMode == cPP) trackTree        = (TTree*) inf->Get("ppTrack/trackTree");
...
*/        
     /*   //for 2013 pp 2.76 TeV MC with pp tracking
     ...
     */   //for 2013 pp 5 TeV MC with pp tracking
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj50_ak3PF_100_-1_-1000_genJetMode0.root", 50) ;
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj80_ak3PF_100_-1_-1000_genJetMode0.root", 80) ;
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj120_ak3PF_100_-1_-1000_genJetMode0.root", 120) ;
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj170_ak3PF_100_-1_-1000_genJetMode0.root", 170) ;
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj220_ak3PF_100_-1_-1000_genJetMode0.root", 220) ;
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_pythia5TeV_Sigdj280_ak3PF_100_-1_-1000_genJetMode0.root", 280) ;
